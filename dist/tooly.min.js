...
define("tooly/wordpress/bbpress/editor",["jquery","tooly/wordpress/wordpress","tooly/bootstrap/modal","tooly/wordpress/bbpress"],function(e,t,s,o){return{Helper:{initForm:function(e,t){if(QTags.getInstance(e).canvas.value){quicktags({id:e,buttons:t})}return this},addQutoedReply:function(e,t){return QTags.getInstance(e).canvas.value="<blockquote>"+t+"</blockquote>",this},reset:function(t,s){return QTags.getInstance(t),void 0!==s&&(QTags.getInstance(t).canvas.value="",e("#"+s).val("")),this}}}}),define("wordpress/bbpress-editor.js",function(){});
define("tooly/wordpress/bbpress/config",{replyFormClass:".bbp-reply-form",topicReplyLinkClass:".bbp-topic-reply-link",replyReplyLinkClass:".bbp-reply-to-link",newTopicLinkClass:".new-topic-button",newTopicFormClass:".bbp-topic-form",modalClass:".modal-bbpress",warning:'<div class="alert alert-warning">Üye olmalı veya üye girişi yapmalısınız. <a href="">Giriş</a> </div>'}),define("tooly/wordpress/bbpress",["jquery","tooly/wordpress/wordpress","tooly/bootstrap/modal","tooly/wordpress/bbpress/config","tooly/wordpress/bbpress/editor"],function(e,p,r,o,t){function n(e){var p=e.match(/bbp_reply_to\=([0-9]*)/m);return p.index>=0?p[1]:!1}function l(p){if(!i(c.newTopicFormOpen,p.target)){var r=e(o.newTopicFormClass);a.register("bbpress_newTopicForm",r).show(),t.Helper.initForm("bbp_topic_content").reset("bbp_topic_content","bbp_topic_title"),p.preventDefault(),i(c.newTopicFormOpened,p.target)}}function i(e,p){var r=tooly.EventManager.createEvent(e,p);return tooly.EventManager.dispatch(r),r.cancel}function s(r){if(!i(c.topicReplyFormOpen,r.target)){var l=0,s="",b=e(o.replyFormClass),y=e(r.target).parent().parent().parent().find("bbp-reply-content").html();r.target.className.indexOf(o.topicReplyLinkClass.replace(".",""))>=0?s="topic":r.target.className.indexOf(o.replyReplyLinkClass.replace(".",""))>=0&&(s="reply",l=n(r.target.href));var d=(b.find("#bbp-cancel-reply-to-link"),b.find("#bbp_reply_to")),m=b.find("#bbp_topic_id");d.val(l),m.val(p.Helper.getPostId()),a.register("bbpress_replyForm",b).show(),t.Helper.initForm("bbp_reply_content").reset("bbp_reply_content").addQutoedReply("bbp_reply_content",y),r.preventDefault(),i(c.topicReplyFormOpened,r.target)}}var a=r.Helper.createController(o.modalClass),c={newTopicFormOpen:"tooly.bbpress.newTopicFormOpen",newTopicFormOpened:"tooly.bbpress.newTopicFormOpened",topicReplyFormOpen:"tooly.bbpress.topicReplyFormOpen",topicReplyFormOpened:"tooly.bbpress.topicReplyFormOpened"},b={init:function(){switch(p.Helper.getPageType()){case"topic":e(o.topicReplyLinkClass).bind("click",s),e(o.replyReplyLinkClass).bind("click",s);break;case"forum":e(o.newTopicLinkClass).bind("click",l)}},unload:function(){e(o.topicReplyLinkClass).unbind("click",s),a.unload()}};return{Event:c,Helper:b}}),define("wordpress/bbpress.js",function(){});
