...
define("tooly/wordpress/bbpress/config",{replyFormClass:".bbp-reply-form",topicReplyLinkClass:".bbp-topic-reply-link",replyReplyLinkClass:".bbp-reply-to-link",newTopicLinkClass:".new-topic-button",newTopicFormClass:".bbp-topic-form",modalClass:".modal-bbpress",warning:'<div class="alert alert-warning">Üye olmalı veya üye girişi yapmalısınız. <a href="">Giriş</a> </div>'}),define("tooly/wordpress/bbpress",["jquery","tooly/wordpress/wordpress","tooly/bootstrap/modal","tooly/wordpress/bbpress/config","tooly/wordpress/bbpress/editor"],function(e,o,r,p,n){function t(e){var o=e.match(/bbp_reply_to\=([0-9]*)/m);return o.index>=0?o[1]:!1}function i(o){if(!l(c.newTopicFormOpen,o.target)){var r=e(p.newTopicFormClass);a.register("bbpress_newTopicForm",r).show(),n.Helper.initForm("bbp_topic_content").reset("bbp_topic_content","bbp_topic_title"),o.preventDefault(),l(c.newTopicFormOpened,o.target)}}function l(e,o){var r=tooly.EventManager.createEvent(e,o);return tooly.EventManager.dispatch(r),r.cancel}function s(r){if(!l(c.topicReplyFormOpen,r.target)){var n=0,i="",s=e(p.replyFormClass);r.target.className.indexOf(p.topicReplyLinkClass.replace(".",""))>=0?i="topic":r.target.className.indexOf(p.replyReplyLinkClass.replace(".",""))>=0&&(i="reply",n=t(r.target.href));var b=(s.find("#bbp-cancel-reply-to-link"),s.find("#bbp_reply_to")),y=s.find("#bbp_topic_id");b.val(n),y.val(o.Helper.getPostId()),a.register("bbpress_replyForm",s).show(),r.preventDefault(),l(c.topicReplyFormOpened,r.target)}}var a=r.Helper.createController(p.modalClass),c={newTopicFormOpen:"tooly.bbpress.newTopicFormOpen",newTopicFormOpened:"tooly.bbpress.newTopicFormOpened",topicReplyFormOpen:"tooly.bbpress.topicReplyFormOpen",topicReplyFormOpened:"tooly.bbpress.topicReplyFormOpened"},b={init:function(){switch(o.Helper.getPageType()){case"topic":e(p.topicReplyLinkClass).bind("click",s),e(p.replyReplyLinkClass).bind("click",s);break;case"forum":e(p.newTopicLinkClass).bind("click",i)}},unload:function(){e(p.topicReplyLinkClass).unbind("click",s),a.unload()}};return{Event:c,Helper:b}}),define("wordpress/bbpress.js",function(){});
