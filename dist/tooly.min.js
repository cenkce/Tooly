...
define("tooly/wordpress/bbpress/editor",["jquery","tooly/wordpress/wordpress","tooly/bootstrap/modal","tooly/wordpress/bbpress"],function(t,e,o,s){return{Helper:{initForm:function(t,e){if(QTags.getInstance("bbp_topic_content").canvas.value){quicktags({id:t,buttons:e})}QTags.getInstance("bbp_topic_content"),QTags.getInstance("bbp_topic_content").canvas.value=""},addQutoedReply:function(t,e){QTags.getInstance(t).canvas.value="<blockquote>"+e+"</blockquote>"}}}}),define("wordpress/bbpress-editor.js",function(){});
define("tooly/wordpress/bbpress/config",{replyFormClass:".bbp-reply-form",topicReplyLinkClass:".bbp-topic-reply-link",replyReplyLinkClass:".bbp-reply-to-link",newTopicLinkClass:".new-topic-button",newTopicFormClass:".bbp-topic-form",modalClass:".modal-bbpress",warning:'<div class="alert alert-warning">Üye olmalı veya üye girişi yapmalısınız. <a href="">Giriş</a> </div>'}),define("tooly/wordpress/bbpress",["jquery","tooly/wordpress/wordpress","tooly/bootstrap/modal","tooly/wordpress/bbpress/config","tooly/wordpress/bbpress/editor"],function(e,r,o,p,n){function i(e){var r=e.match(/bbp_reply_to\=([0-9]*)/m);return r.index>=0?r[1]:!1}function l(r){if(!s(c.newTopicFormOpen,r.target)){var o=e(p.newTopicFormClass);a.register("bbpress_newTopicForm",o).show(),n.Helper.initForm(o.find("form")),r.preventDefault(),s(c.newTopicFormOpened,r.target)}}function s(e,r){var o=tooly.EventManager.createEvent(e,r);return tooly.EventManager.dispatch(o),o.cancel}function t(o){if(!s(c.topicReplyFormOpen,o.target)){var l=0,t="",b=e(p.replyFormClass);o.target.className.indexOf(p.topicReplyLinkClass.replace(".",""))>=0?t="topic":o.target.className.indexOf(p.replyReplyLinkClass.replace(".",""))>=0&&(t="reply",l=i(o.target.href));var y=(b.find("#bbp-cancel-reply-to-link"),b.find("#bbp_reply_to")),d=b.find("#bbp_topic_id");y.val(l),d.val(r.Helper.getPostId()),a.register("bbpress_replyForm",b).show(),n.Helper.initForm(b.find("form")),o.preventDefault(),s(c.topicReplyFormOpened,o.target)}}var a=o.Helper.createController(p.modalClass),c={newTopicFormOpen:"tooly.bbpress.newTopicFormOpen",newTopicFormOpened:"tooly.bbpress.newTopicFormOpened",topicReplyFormOpen:"tooly.bbpress.topicReplyFormOpen",topicReplyFormOpened:"tooly.bbpress.topicReplyFormOpened"},b={init:function(){switch(r.Helper.getPageType()){case"topic":e(p.topicReplyLinkClass).bind("click",t),e(p.replyReplyLinkClass).bind("click",t);break;case"forum":e(p.newTopicLinkClass).bind("click",l)}},unload:function(){e(p.topicReplyLinkClass).unbind("click",t),a.unload()}};return{Event:c,Helper:b}}),define("wordpress/bbpress.js",function(){});
